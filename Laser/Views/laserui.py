...
# Form implementation generated from reading ui_ramp file 'Views/laserui.ui_ramp'
#
...
from Views.cplotview import CplotView
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow: QtWidgets.QMainWindow):
        ...
        self.afg_label.setText(_translate("MainWindow", "Red Pitaya Controller"))
...
class WorkerThread(QThread, Ui_MainWindow):
    ...
    def run(self):
        ...
        try:
            ...
            self.dialog_browser.setText('problem with the thread, grow the period time : self.time.setInterval(ms)')
